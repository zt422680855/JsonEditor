...
public class Right extends JsonEditorModdle {
    ...
    private JBMenuItem addSub = new JBMenuItem("add child", AllIcons.Actions.AddMulticaret);
    private JBMenuItem addSibling = new JBMenuItem("add sibling", AllIcons.Actions.AddMulticaret);
    private JBMenuItem edit = new JBMenuItem("edit", AllIcons.Actions.Edit);
    private JBMenuItem delete = new JBMenuItem("delete", AllIcons.Actions.DeleteTag);
    private JBMenuItem copy = new JBMenuItem("copy", AllIcons.Actions.Copy);
    private JBMenuItem copyKey = new JBMenuItem("copy key", AllIcons.Actions.Copy);
    private JBMenuItem copyValue = new JBMenuItem("copy value", AllIcons.Debugger.Value);
    ...
    private void checkAndShowContextMenu(MouseEvent e) {
